...
const SearchPage = () => {
  return (
    <div className="flex flex-col md:flex-row">
      <div className="p-4 w-full md:max-w-xs border-b-2 border-gray-300 md:border-r-2 md:min-h-screen">
      ...
      <div className="">
        <h1 className="text-3xl font-semibold border-b border-gray-200 p-3 text-slate-700 mt-5">Listing results</h1>
      </div>
    </div>
  );
};
